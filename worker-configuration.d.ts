/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4e8f2b694047d9e6eb1f103c7db0390d)
...
interface __BaseEnv_Env {
	...
	METHODOLOGY_CACHE: KVNamespace;
	DB: D1Database;
	PRODUCT_EVIDENCE_INDEX: VectorizeIndex;
	SCAN_ANALYTICS: AnalyticsEngineDataset;
	INGESTION_QUEUE: Queue;
	NOTIFICATION_QUEUE: Queue;
	AI: Ai;
	ASSETS: Fetcher;
	ENVIRONMENT: "production";
	CANONICAL_HOST: "optiyou.co";
	APPLE_CLIENT_ID: "co.optiyou.app";
	AUTH_JWT_ISSUER: "https://optiyou.co";
	AUTH_JWT_AUDIENCE: "optiyou-ios";
	AUTH_SESSION_TTL_SECONDS: "3600";
	AUTH_APPLE_NONCE_TTL_SECONDS: "600";
	UPLOAD_TOKEN_TTL_SECONDS: "900";
	METHODOLOGY_VERSION: "food-us-ca-v1";
	ANALYTICS_ACCOUNT_ID: "75c2ecd9fee15d06f93013c411f31aaa";
	SCAN_ANALYTICS_DATASET: "optiyou_scan_analytics";
	ADMIN_EMAILS: "kaden@winten.ai";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CANONICAL_HOST" | "APPLE_CLIENT_ID" | "AUTH_JWT_ISSUER" | "AUTH_JWT_AUDIENCE" | "AUTH_SESSION_TTL_SECONDS" | "AUTH_APPLE_NONCE_TTL_SECONDS" | "UPLOAD_TOKEN_TTL_SECONDS" | "METHODOLOGY_VERSION" | "ANALYTICS_ACCOUNT_ID" | "SCAN_ANALYTICS_DATASET" | "ADMIN_EMAILS" | "AI_GATEWAY_BASE_URL">> {}
}
